codeunit 50100 "CSD Seminar-Post"
{
    ...
    begin
        ...
        with SeminarRegHeader do begin
            ...
            if SeminarRegHeader."Posting No." = ''
            then begin
    ...
    begin
        ...
        if SeminarCharge.FindSet(false, false)
        then repeat
